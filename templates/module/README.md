...
Return business JSON through `respondWithSuccess` and `respondWithFailure`. These helpers own the standard `code/message/data/timestamp` envelope, cache policy, and the trusted error-code response header consumed by Platform call logs.
